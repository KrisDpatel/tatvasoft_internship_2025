...
namespace Mission.Api.Controllers
{
    ...
    public class MissionSkillController(IMissionSkillService missionSkillService) : ControllerBase
    {
        ...
        {
            await _missionSkillService.AddMissionSkillsAsync(model);
        ...
        public async Task<IActionResult> GetMissionSkillList()
        {
            ...
            var result = new ResponseResult() { Data = response, Result = ResponseStatus.Success, Message = "New Mission Skill Added" };
        ...
        {
            var response = await _missionSkillService.UpdateMissionSkill(model);
